...
## Tutor Notes
[Deployment](https://tutoring.pasbola.com)

Minimal study platform designed for structured revision, immersive reading, and lightweight educational content delivery.

**Highlights**
- Static architecture optimized for fast loading
- Clean URL routing with Vercel rewrites
- Subject-based organization and navigation
- Reading-focused UI and aesthetic note layouts
...
* AI-generated MCQs and revision questions
* Persistent contextual chat sessions
* Document ingestion and study assistance
